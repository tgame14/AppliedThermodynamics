...
public class BlockExhaustME extends BlockContainer {
	...
	public void registerIcons(IconRegister iconregister) {
		...
		frontIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.EXHAUST_TEXTURES[0]);
        sideIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.EXHAUST_TEXTURES[1]);
        bottomIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.MONITOR_TEXTURES[0]);
        topIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.MONITOR_TEXTURES[0]);
	}
