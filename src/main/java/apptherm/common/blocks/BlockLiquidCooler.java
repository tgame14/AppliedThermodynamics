...
public class BlockLiquidCooler extends BlockContainer {
	...
	public void registerIcons(IconRegister iconregister) {
		...
		frontIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.LIQUICOOL_TEXUTRES[0]);
		sideIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.DEFAULT_TEXTURES[1]);
		bottomIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.DEFAULT_TEXTURES[0]);
		topIcon = iconregister.registerIcon(ModInfo.TEXTURE_LOCATION + ":" + BlockInfo.DEFAULT_TEXTURES[0]);
	}
